...
class FrameFileUploadPneumonia(QWidget):
    def __init__(self):
        super().__init__()
        self.widgets()
    ...
    def open_file(self):
        ...
        if filename:
            ...
            Parametro2.get_instance().path2 = filename  # Guardar el nombre del archivo en el parámetro
    ...
    def acept_submit(self):
        ...
        self.step2_pneumonia = MenuPneumonia()
        self.step2_pneumonia.fill_values_in_input_parameters()
