...
from components.general.FrameStep1.FrameImage import ImageWidgetFracture
from components.general.FrameStep2.FrameValidate import ValidateFrameFracture
from entity.parametros import Parametro




class MenuFracture(QWidget):
    def __init__(self):
        super(MenuFracture, self).__init__()
        ...
        from ui.BonesFracture.fileUpload import FrameFileUpload
        self.instance_file_upload = FrameFileUpload()


        self.instance_image = ImageWidgetFracture()
        self.instance_image.set_image(Parametro.get_instance().path)
        print(f"Instance image --> {self.instance_image}")

        self.instance_validate = ValidateFrameFracture()
        ...
        self.stacked_widget.addWidget(self.create_page("Configuracion Paso 2",None, self.instance_image, 2, True, True))
        self.stacked_widget.addWidget(self.create_final_page("Proceso de instalación",  3, True, True))
